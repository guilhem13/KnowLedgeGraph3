...
class Textprocessed:
    ...
    def filter_entities(self, entity):
        ...
        stop =False
        index = 0
        forbidden_list =['Analysis','Pattern','Recognition','Vision','Computer-Assisted','Ubiquitous','Computing','Neuroscience','Clinical','Stochastic','Procedures','Applications','Engineers','Statistics','Graphical','Electronics','Computer','Learning','Machine','Artificial','Intelligence','Computer','Science','Representation','Continuous','Facilities','Council','Dominican','Republic','Multiagent','Systems','Autonomous','Agents','Biometrics','Lab','Physics','Neural','Systems','Mathematics','Mathematical','Computational','Meta-Learning',"Parameter","Available","Online","Practical","Momentum","AGCN","AGCN","Engineering","Data","Retrieval","Programming","Research","Verification","Network","Interestingly","Sciences","Representations","Foundations","Knowledge","Discovery","Conference","Proceedings","Potentials","Interfaces"]
